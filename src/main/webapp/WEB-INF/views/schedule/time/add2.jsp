...
<body>
	<form action="${pageContext.request.contextPath}/schedule/time/add2.do"
		method="post">
		<fieldset>
			<legend><c:out value="${svo.scheTitle} 의 알람시간 등록 (2)"/> </legend>
			<input type="hidden" name="scheId" value="${svo.scheId}"/>
			<ul>
				<label for="timeId">2회차 제목</label>
