...
import timepill.schedule.service.impl.ScheduleService;
...
public class ScheduleController {
	...
	public String registAlarmSet(ScheduleVO vo, ModelMap model, HttpSession session) throws Exception {
		String userId = ((UserVO) session.getAttribute("loginUser")).getUserId();
		vo.setUserId(userId);
	...
	public void setAlarmSet(@RequestBody List<ScheduleVO> resultList) throws Exception {
